...
<asp:Content runat="server" ID="content1" ContentPlaceHolderID="ContentPlaceHolder1">
    <asp:Panel ID="Panel1" runat="server" CssClass="left">
        ...
        <asp:RequiredFieldValidator ValidationGroup="G1" ForeColor="Red" ControlToValidate="companies" ID="RequiredFieldValidator1" runat="server" ErrorMessage="*Company name is required" style="z-index: 1; left: 24px; top: 35px; position: absolute"></asp:RequiredFieldValidator>
        <br/>
        ...
        <asp:RequiredFieldValidator ValidationGroup="G1" ForeColor="Red" ControlToValidate="source" ID="RequiredFieldValidator2" runat="server" ErrorMessage="*Source city is required" style="z-index: 1; left: 26px; top: 72px; position: absolute"></asp:RequiredFieldValidator>
        <br/>
        ...
        <asp:RequiredFieldValidator ValidationGroup="G1" ForeColor="Red" ControlToValidate="destination" ID="RequiredFieldValidator3" runat="server" ErrorMessage="*Destination city is required" style="z-index: 1; left: 23px; top: 104px; position: absolute"></asp:RequiredFieldValidator>
        <br/>
        ...
        <asp:RequiredFieldValidator ValidationGroup="G1" ForeColor="Red" ControlToValidate="stime" ID="RequiredFieldValidator4" runat="server" ErrorMessage="*Start time is required" style="z-index: 1; left: 22px; top: 138px; position: absolute"></asp:RequiredFieldValidator>
        <br/>
        ...
        <asp:RequiredFieldValidator ValidationGroup="G1" ForeColor="Red" ControlToValidate="etime" ID="RequiredFieldValidator5" runat="server" ErrorMessage="*End time is required" style="z-index: 1; left: 24px; top: 179px; position: absolute"></asp:RequiredFieldValidator>
        <br/>
        ...
        <asp:Calendar ID="Calendar1" runat="server" style="z-index: 1; left: 157px; top: 213px; position: absolute; height: 70px; width: 150px"></asp:Calendar>
        <br/>
        ...
        <asp:ValidationSummary ID="ValidationSummary1" ValidationGroup="G1" runat="server" style="z-index: 1; left: -5px; top: 263px; position: absolute; height: 28px; width: 400px" />
    </asp:Panel>
    ...
    <asp:Panel ID="Panel3" runat="server" CssClass="right">
            ...
            <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="false" AllowPaging="true" PageSize="10" AutoGenerateSelectButton="true" CellSpacing="1" OnSelectedIndexChanging="selection_changed" sortExpression="id" 
                  OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataSourceID ="SqlDataSource1" Font-Size="Large" AllowSorting="true" AlternatingRowStyle-BackColor="LightBlue" BorderStyle="Dashed" style="z-index: 1; left: 8px; top: 63px; position: absolute; height: 141px; width: 438px; margin-bottom: 0px">
                <columns>
        ...
        <br/>
        <asp:Label ID="seats" runat="server" Text="Number of tickets you would like to book: " style="z-index: 1; left: 13px; top: 403px; position: absolute"></asp:Label><asp:TextBox ID="num_seats" runat="server" style="z-index: 1; left: 256px; top: 396px; position: absolute; height: 22px"></asp:TextBox>
        <br/>
